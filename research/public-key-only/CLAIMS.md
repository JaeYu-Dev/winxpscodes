...
| C-011 | Joint SystemFunction036 ancestry before first Bitcoin key yields search <2^128 | OPEN | primary break theorem target |
...
| C-015 | Within one shipped-SP3 RSAENH CGR64 call, the second SystemFunction036 input has no independent stack-prehistory root | OPEN | later composition target |
