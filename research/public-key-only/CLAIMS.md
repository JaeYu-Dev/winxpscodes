...
| C-010 | The 8 ADVAPI entries constitute eight independent 160+ bit unknowns before first key | OPEN | likely over-counting; must quotient by rekey recurrence |
...
## Rule
No claim moves to CONFIRMED from source inspection alone when the target is SP3 shipped behavior. Exact binary or controlled trace/replay evidence is required.